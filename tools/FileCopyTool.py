...
class FileCopyToolInput(ToolInput):
    source_path: str = ToolField(
        title="Source Path", description="""The path of the file to read."""
    )
...
class FileCopyTool(ToolWrapper):
    name: str = "FileCopyTool"
    description: str = (
        "This tool receives two paths, one of a file and another of a directory, copies the file to the "
