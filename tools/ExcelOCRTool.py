...
class ExcelOCRToolInput(ToolInput):
    ...
    question: str = ToolField(
        description="Precise instruction on what to extract from the file content."
    )


GET_JSON_PROMPT: Final[
    str
] = """Extract all useful information from the Excel file as a structured JSON. Don't summarize or omit rows."""
