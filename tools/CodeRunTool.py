...
class CodeRunTool(ToolWrapper):
    name: str = "CodeRunTool"
    description: str = 'A Python shell tool. Example of input: { "command": "print(\'Hello, World!\')" }'
    ...
    def run(self, input_params: Dict, *args, **kwargs):
        ...
        if (
            result.startswith("SyntaxError")
            or result.startswith("ZeroDivisionError")
